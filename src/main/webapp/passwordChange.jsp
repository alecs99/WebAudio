...
<div class="card">
    <div class="card-title">
        <h2>Insert your current password and the new password</h2>
    </div>
    <div class="card-body">
        <form action="ChangePasswordServlet" method="post">
            <div class="input-group mb-3">
                <input type="password" name="oldPass" placeholder="Insert your current password">
            </div>
            <div class="input-group">
                <input type="password" name="newPass" placeholder="Insert your new password">
            </div>
